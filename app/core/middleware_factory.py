...
from ..middleware.security import SecurityMiddleware, logging_middleware, error_handling_middleware
...
class MiddlewareFactory:
    ...
    def setup_trusted_host_middleware(app: FastAPI) -> None:
        ...
        logger.debug(f"✅ Trusted host middleware added with hosts: {settings.trusted_hosts}")
