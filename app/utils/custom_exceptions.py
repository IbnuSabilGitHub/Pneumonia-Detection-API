...
class InvalidImageContentError(FileValidationError):
    ...
    def __init__(self, reason: str):
        super().__init__(
            f"Invalid image content: {reason}",
            {"validation_type": "image_content"}
        )
...
class SecurityError(PneumoniaAPIException):
    ...
    def __init__(self, violation_type: str, reason: str, client_info: Optional[Dict[str, Any]] = None):
        super().__init__(
...
class AttackDetectedError(SecurityError):
    ...
    def __init__(self, attack_type: str, client_ip: str, details: Optional[Dict[str, Any]] = None):
